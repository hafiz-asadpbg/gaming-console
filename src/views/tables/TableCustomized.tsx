...
const createData = (name: string, email: string, password: string, age: number, country: string) => {
  return { name, email, password, age, country };
};

const rows = [
  createData('Frozen yoghurt etc', 'abd@gmail.com', 'Pc/Ps 4', 4.0, 'pakistan'),
  createData('Ice cream sandwich', 'abd@gmail.com', 'Pc/Ps 4', 4.3, 'pakistan'),
  createData('Eclair cream sandw', 'abd@gmail.com', 'Pc/Ps 4', 6.0, 'pakistan'),
  createData('Frozen yoghurt etc', 'abd@gmail.com', 'Pc/Ps 4', 4.3, 'pakistan'),
  createData('Frozen yoghurt etc', 'abd@gmail.com', 'Pc/Ps 4', 3.9, 'pakistan'),
];
        ...
        <TableBody>
          {rows.map((rows, index) => (
            <TableRow key={index}>
              ...
              <TableCell>{rows.password}</TableCell>
